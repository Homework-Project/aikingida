...
(function($) {
    ...
    $.fn.mask = function(options) {
        options = $.extend({
            spinner: {lines: 5, length: 0, width: 20, radius: 22, corners: 0.6, rotate: 54, direction: 1, color: '#000', speed: 1.2, trail: 70, shadow: false, hwaccel: false, className: 'spinner', zIndex: 2e9, top: 'auto', left: 'auto'},
            spinnerPadding: 5,
            label: "",
            delay: 0,
            overlayOpacity: 0.5,
    ...
    $.maskElement = function(element, options) {
        ...
        maskDiv.fadeTo('slow', options.overlayOpacity).css("background", "whitesmoke");
    };
