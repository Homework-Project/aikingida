var LocalStorageStore = function(successCallback, errorCallback) {
    ...
    this.findByName = function(searchKey, callback) {
        var employees = JSON.parse(window.localStorage.getItem("zumaemployee"));
    ...
    var employees = [
            {"id": 1, "firstName": "ARyan", "lastName": "Howard", "title":"Vice President, North East", "managerId": 0, "city":"New York, NY", "cellPhone":"212-999-8888", "officePhone":"212-999-8887", "email":"ryan@dundermifflin.com"},
    ...
    window.localStorage.setItem("zumaemployee", JSON.stringify(employees));
